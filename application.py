#! python3
"""
@created: 2020-05-22 10:33:35
@author: NAVEEN RAJU.K
...
def show_about():
	...
	text.insert(tk.END, 'Author : NAVEEN RAJU.K \n')
	text.insert(tk.END, 'MAIL ID : naveenkanagaraju1901@gmail.com \n')
	text.insert(tk.END, 'Phone Number : +91 7094240070')
...
def get_help():
	url = 'https://github.com/NaveenRaju19/Text-Editor'
	webbrowser.open(url)
